...
LangString DrivePage_Title2 ${LANG_ENGLISH} "Choose the USB drive on which to install SliTaz."
LangString DrivePage_Text ${LANG_ENGLISH} "TazUSB will install SliTaz on the following drive. Make sure that this drive can be safely deleted! Click Next to continue."
...
; Russian
LangString Welcome_Title ${LANG_RUSSIAN} "${NAME}"
LangString Welcome_Text ${LANG_RUSSIAN} "TazUSB установит SliTaz на носитель USB."
LangString Finish_Title ${LANG_RUSSIAN} "Установка SliTaz завершена."
LangString Finish_Text ${LANG_RUSSIAN} "Теперь SliTaz установлен на загрузочный носитель USB."
LangString Finish_Link ${LANG_RUSSIAN} "Сайт SliTaz"
LangString IsoPage_Title ${LANG_RUSSIAN} "Выбор файла ISO"
LangString IsoPage_Title2 ${LANG_RUSSIAN} "Выберите образ ISO, который будет установлен на носитель USB."
LangString IsoPage_Text ${LANG_RUSSIAN} "Выберите файл образа SliTaz, который будет установлен на носитель USB. При необходимости вы можете загрузить его на http://www.slitaz.org."
LangString IsoPage_Input ${LANG_RUSSIAN} "Файл SliTaz ISO"
LangString IsoFile ${LANG_RUSSIAN} "Файл ISO|*.iso"
LangString DrivePage_Title ${LANG_RUSSIAN} "Выбор носителя USB"
LangString DrivePage_Title2 ${LANG_RUSSIAN} "Выберите носитель USB, на который будет установлен SliTaz."
LangString DrivePage_Text ${LANG_RUSSIAN} "TazUSB установить SliTaz на указанный носитель. Убедитесь, что на нём отсутствуют важные файлы, так как всё будет удалено! Нажмите Далее для продолжения."
LangString DrivePage_Input ${LANG_RUSSIAN} "Целевой носитель USB"
LangString WarningPage_Title ${LANG_RUSSIAN} "Внимание!"
LangString WarningPage_Title2 ${LANG_RUSSIAN} "TazUSB готов установить SliTaz на указанный носитель."
LangString WarningPage_Text ${LANG_RUSSIAN} "Теперь TazUSB готов установить SliTaz из образа$\r$\n$\r$\n$IsoFile $\r$\n$\r$\nна выбранный носитель USB$\r$\n$\r$\n$DestDrive. $\r$\n$\r$\nСодержимое этого носителя будет удалено! Нажмите Далее для продолжения."
LangString Iso2USB_Extract ${LANG_RUSSIAN} "Извлечение файлов из образа $IsoFile"
LangString Iso2USB_CreateSyslinux ${LANG_RUSSIAN} "Настройка syslinux на носителе $DestDrive"
LangString Iso2USB_ExecuteSyslinux ${LANG_RUSSIAN} "Запуск syslinux на $R0"
LangString Iso2USB_WarningSyslinux ${LANG_RUSSIAN} "При выполнении syslinux возникла ошибка ($R8).$\r$\nНоситель USB не будет загрузочным…"
